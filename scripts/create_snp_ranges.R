...
# Filter for only repeats with unique IDs, to prevent biasing from repeats duplicated through other
# mechanisms
...
# these two commands can be removed once the switch to overlap functions is complete
